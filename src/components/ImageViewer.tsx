...
interface ImageViewerProps {
  ...
  isTransitioningFromGrid: boolean;
}
...
export const ImageViewer = ({
  ...
  const shouldApplyViewTransitionName = isNavigating || isTransitioningFromGrid;

  const transitionStyle = shouldApplyViewTransitionName
